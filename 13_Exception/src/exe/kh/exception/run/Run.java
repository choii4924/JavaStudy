package exe.kh.exception.run;

import exe.kh.exception.A_UnCheckedException;
import exe.kh.exception.B_CheackedException;
import exe.kh.exception.MyException;
...
public class Run {
	...
	public static void main(String[] args) {
		...
		B_CheackedException b = new B_CheackedException();
		// b.test1();
