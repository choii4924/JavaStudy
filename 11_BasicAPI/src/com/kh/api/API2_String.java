...
public class API2_String {
	...
	public static void test1() {
		...
		//		같은 곳을 가리키게 됨! (주소 갑이 같음!)
		
		System.out.println( Str1 == "Happy");
		// str1이 가리키고 있는 주소와 "Happy"라는 값ㅇ 자체가 저장된 주솔르 비교
		...
		System.out.println( Str3.equals("Happy") );
	        ...
	        // * 문자형 배열 -> 문자열로 변환 : static value0f(배열): String
	        System.out.println(String.valueOf(arr));
	        
	}
	
	public static void test2() {
		// * equals => 문자열A. equals(문자열:B):boolean
		...
		System.out.println(Str1.charAt(Str1.length() - 1)); // 결과: 'o'
		
		// toUpperCase => 문자열.toUpperCase():String
		//				  해당 문자열의 알파벳을 모두 대문자로 변환하여 리턴
		// toLowerCase => 문자열.toUpperCase():String
		// 				  해당 문자열의 알파벳을 모두 대문자로 변환하여 리턴
		...
		//				   해당 문자열을 구분하를 기준으로 분리하여 문자열 배열형태로 반환
